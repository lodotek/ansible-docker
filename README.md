## What is ansible-docker? [![Build Status](https://secure.travis-ci.org/lodotek/ansible-docker.png)](http://travis-ci.org/lodotek/ansible-docker)
...
- name: "Configure app server(s)"
  ...
  roles:
    - { role: "lodotek.docker", tags: "docker" }
```
...
[user role](https://github.com/lodotek/ansible-user)*.

Now you would run `ansible-playbook -i inventory/hosts site.yml -t docker`.

## Installation

`$ ansible-galaxy install lodotek.docker`

## Ansible Galaxy

You can find it on the official
[Ansible Galaxy](https://galaxy.ansible.com/lodotek/docker/) if you want to
rate it.
